...
class FlightBrowserScraper:
    ...
    def _build_url(self, origin: str, dest: str, dep: str, ret: Optional[str]) -> str:
        """Build Google Flights URL."""
        params = f"?gl=US&hl=en&source=m6"
    ...
    def _scrape_with_agent_browser(self, url: str) -> Dict:
        ...
        subprocess.run(["agent-browser", "screenshot", "/tmp/flights.png"], capture_output=True)
